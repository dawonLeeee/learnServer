...
@WebServlet("/login") // web.xml에 작성하던 <servlet>, <servlet-mapping> 태그 대신하는 어노테이션
public class LoginServlet extends HttpServlet{
	
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		
//		post방식 요청 데이터 문자열 처리
		req.setCharacterEncoding("UTF-8");
		
		

//		전달받은 파라미터를 얻어와 변수에 저장
...
//				-->webapp폴더 내부의 WEB-INF폴더 내부의 views내부의 loginResult.jsp파일 선택
//			
//		**** forward ****
//		- 보내다, 전달하다, 전송하다
...
//		req.setAttribute(String key, Object value); // attribute : 속성==데이터(값)
	}
